...
<body>
	<div class="layui-container">
		<form id="form1" class="layui-form" style="margin-top: 4%">
			<input id="id" name="id" type="hidden" value="${friendType.id}" />
    ...
    layui.use('form', function(){
        ...
        form.on('submit(save)', function(data){
            ...
            var params={"id":id,"typeName":typeName};
            $.ajax({
                type : 'POST',
                url :'/friend/updateFriendTypeName',
                data :params,
                dataType : 'json',
                success : function(obj) {
                    if(obj.code == 0){
                        ...
                        parent.updateFriendTypeNameLi(typeName,id)
                    }else{
