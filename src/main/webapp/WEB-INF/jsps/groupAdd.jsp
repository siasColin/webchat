...
<body>
			...
			<div class="layui-row">
				...
				<div class="layui-col-xs10">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<img id="avatarGroup" src="/images/boy-01.png" style="border-radius: 50%;width: 50px;height: 50px;margin-top: 5px;cursor: pointer;">
						</div>
					</div>
				</div>
			</div>
    ...
    layui.use(['form','upload'], function(){
        ...
        form.on('submit(save)', function(data){
            ...
            var params={"userId":userId,"groupName":groupName,"groupNum":groupNum,"description":description,"userId":userId,"avatar":avatar};
            $.ajax({
                type : 'POST',
                url :'/group/addGroup',
                data :params,
                ...
                success : function(obj) {
                    if(obj.code == 0){
                        ...
                        parent.appendGroup(groupName,description,obj.id);
                    }else{
